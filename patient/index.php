            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor">
                        <a href="doctors.php" class="non-style-link-menu"><div><p class="menu-text">All Service Providers</p></a></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about UASp? no problem let's jumping to 
                                <a href="doctors.php" class="non-style-link"><b>"All Service Providers"</b></a><br>section or 
                                <a href="schedule.php" class="non-style-link"><b>"Sessions"</b> </a><br>
                                Track your past and future appointments history.<br>Also find out the expected arrival time of your service provider.<br><br>
                            </p>
                            
                            <h3>Channel a Provider Here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Search Provider and We will Find The Session Available" list="doctors" style="width:45%;">&nbsp;&nbsp;
